...
-- Wrapper    : crc_32_iso_hdlc_d32_axis
-- CRC core   : crc_32_iso_hdlc_d32
-- Data width : 32 bits
-- Generated  : 2026-03-06T06:17:39Z
--
-- Analyse both files together:
--   ghdl -a --std=93 crc_32_iso_hdlc_d32.vhd crc_32_iso_hdlc_d32_axis.vhd
-- ==============================================================

library ieee;
use ieee.std_logic_1164.all;

entity crc_32_iso_hdlc_d32_axis is
  port (
    clk           : in  std_logic;
...
end crc_32_iso_hdlc_d32_axis;

architecture rtl of crc_32_iso_hdlc_d32_axis is
...
begin
  ...
  u_crc_core : entity work.crc_32_iso_hdlc_d32(rtl)
    port map (
